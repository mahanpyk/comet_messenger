...
abstract class ContactsRepository extends BaseRepository {
  Future<AuthenticationResponseModel> getContactsList({required RequestModel requestModel});
}

class ContactsRepositoryImpl extends ContactsRepository {
  @override
  Future<AuthenticationResponseModel> getContactsList({required RequestModel requestModel}) async {
