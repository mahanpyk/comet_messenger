...
ChatDetailsResponseModel chatDetailsResponseModelFromJson(Map<String, dynamic> json) => ChatDetailsResponseModel.fromJson(json);

String chatDetailsResponseModelToJson(ChatDetailsResponseModel data) => json.encode(data.toJson());
